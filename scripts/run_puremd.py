...
from ted.calculators.ReaxFFCalculator_puremd import ReaxFFCalculator_PureMD
...
if __name__ == "__main__":
    ...
    reax_calc0 = ReaxFFCalculator_PureMD(ff_file=f'{flag}/reaxff.ff', tmp_dir=f'{flag}/tmp_reax1')
